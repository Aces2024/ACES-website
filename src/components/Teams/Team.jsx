...
const Team = () => {
  const images = [
    { src: lataFitasImage, alt: "Lata Fitas", label: "technical", name:"TECHNICAL" },
    { src: lataPenasImage, alt: "Lata Penas", label: "cultural", name:"CULTURAL" },
    { src: lataBordadoImage, alt: "Lata Bordado", label: "management", name:"MANAGEMENT" },
    { src: lataChitaImage, alt: "Lata Chita", label: "sports", name:"SPORTS" },
  ];
