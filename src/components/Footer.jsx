...
function Footer() {
  ...
  return (
    ...
    <div className='h-1/5  pt-10 pb-10 max-sm:hidden sm:bg-[#151414] lg:bg-[#151414] flex justify-around items-start'>
        ...
        <h1 className='mb-3'>
            ...
            <div class="  ">
  <a class="socialContainer containerOne" href="https://www.instagram.com/acesdypcoe/?igsh=cnQxeTJ4YTVkYzJv">
  ...
  <a class="socialContainer containerThree" href="https://www.linkedin.com/company/aces-dypcoe">
  ...
  <a class="socialContainer containerFour" href="https://www.whatsapp.com/channel/0029VaB0xUFDeON63L7s2C10">
